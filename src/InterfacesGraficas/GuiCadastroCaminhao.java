    ...
    public GuiCadastroCaminhao(ListaVeiculos listaV, JFrame guiGeral) {
        ...
        salvarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (textPlaca.getText().length()==0||textnumEixos.getText().length()==0||textDiaria.getText().length()==0||
                        textAno.getText().length()==0||textCargaMax.getText().length()==0){
                    JOptionPane.showMessageDialog(null, "Preencha as informações do veículo (placa, ano, diária, número de eixos e carga máxima) ", "info", JOptionPane.INFORMATION_MESSAGE);
                }else {
